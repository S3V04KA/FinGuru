...
export default function BigDealCard({ name, description, amount, details, onClick, onClose, onFinishTurn, isOpen, purchased, headerLabel = 'Цена', rightAlign = false, playerCash = 0, playerPassiveIncome = 0, onTakeCredit }: BigDealCardProps): ReactNode {
